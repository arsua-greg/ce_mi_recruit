                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>仕事内容</th>
                            <th>勤務時間<br>
                                <span>8時間拘束7時間実働</span>
                            </th>
                            <th>基本給<span>(特業手当含む)</span><br>
                                <span>1年目 経験年数考慮あり</span>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                ...
                <table class="lasttable">
                    <tbody>
                        <tr>
                            ...
                            <td>被服費800円、処遇Ⅲ8000円、キャリアアップ手当223,000円(2023年実績、年度末支給)、交通費(実費)</td>
                        </tr>
                        <tr>
                            <td>
                                賞与
                            </td>
                            <td>3.6ヵ月(2023年度実績)</td>
                        </tr>
                        <tr>
                            <td>
                                休暇
                            </td>
                            <td>年次有給休暇15日、健康管理休暇12日、夏期休暇6日</td>
                        </tr>
                        <tr>
                            <td>
                                休み
                            </td>
                            <td>日、祝日、年末年始(12/29～1/3)</td>
                        </tr>
                        <tr>
                            <td>
                                加入保険等
                        ...
                        <tr>
                            ...
                            <td>・産休、育休制度あり <br>
                                ・若い職員から子育てしながら働いていいる職員など年齢幅がひろいです。<br>
                                ・新人教育、育成、研修あり<br>
                                ・職員平均年数　8年<br>
                                ・残業ほぼなし</td>
                        </tr>
